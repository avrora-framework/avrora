...
import edu.ucla.cs.compilers.avrora.jintgen.isdl.EnumTypeRef;
...
public class ISDLParser implements ISDLParserConstants
{
    ...
    public List<FormatDecl.Substitution> SubstitutionList()
    ...
    public void SignDimension(HashMap<String, List<Object>> dims)
            throws ParseException
    {
        Token s;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
    ...
    public void SizeDimension(HashMap<String, List<Object>> dims)
            throws ParseException
    {
        Token w;
        jj_consume_token(82);
    ...
    public void TypesDimension(HashMap<String, List<Object>> dims, String n)
            throws ParseException
    {
    ...
    {
        jj_la1_0 = new int[] { 0x7e80000, 0x7e80000, 0x0, 0x80000000, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x42000, 0x80000000, 0x80000000, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x18000000, 0x18000000, 0x40000000, 0x0, 0x20000000,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8002000, 0x0, 0x0,
                0x2000, 0x0, 0x8002000, 0x0, 0x10000000, 0x0, 0x0, 0x18002000,
                0x18002000, 0x8002000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8002000, 0x0,
                0x0, 0x0, 0x0, 0x0, };
    }
    ...
    {
        jj_la1_1 = new int[] { 0x4e04, 0x4e04, 0x4000, 0x0, 0x10000, 0x1,
                0x100000, 0x100000, 0x0, 0x2000, 0x10000, 0x10000, 0x100000,
                0x8000, 0x20000, 0x0, 0x820000, 0x0, 0x0, 0x0, 0x20000,
                0x800000, 0x100000, 0x100000, 0x0, 0x400, 0xe00, 0x100000, 0x0,
                0x100000, 0x202000, 0x0, 0x0, 0x2000, 0x0, 0xc202000, 0x12,
                0x1000, 0x20, 0x0, 0xc223012, 0xc203012, 0xc202000, 0x80, 0x100,
                0x40, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x0, 0x3000000,
                0x3000000, 0xc000000, 0xc000000, 0x70000000, 0x70000000,
                0xc000000, 0xc202000, 0xc000000, 0x0, 0xc000000, 0x100000,
                0xc000000, };
    }
    ...
    {
        jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000,
                0x800, 0x0, 0x0, 0x0, 0x0, 0x8000, 0x8000, 0x0, 0x20000,
                0x20000, 0x0, 0x800, 0x0, 0x0, 0x0, 0x800, 0x0, 0x0, 0x0, 0x800,
                0x0, 0x800, 0x8000, 0x4000, 0x0, 0x4000, 0x80c, 0x0, 0x800, 0x0,
                0x4000, 0x80c, 0x80c, 0x80c, 0x0, 0x0, 0x0, 0x1, 0x2, 0x0, 0x30,
                0x30, 0x3c0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc, 0x80c,
                0x0, 0x40000, 0x0, 0x0, 0x800, };
    }
    ...
    private void jj_add_error_token(int kind, int pos)
    {
        ...
        } else if (jj_endpos != 0)
        {
            ...
            for (Enumeration<int[]> e = jj_expentries.elements(); e
                    .hasMoreElements();)
            {
