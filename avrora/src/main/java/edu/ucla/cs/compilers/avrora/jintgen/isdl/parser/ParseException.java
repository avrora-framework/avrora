 ...
 * exception type by calling the method generateParseException in the generated parser. <p> You can modify
 * this class to customize your error reporting mechanisms so long as you retain the public fields. </p>
 */
public class ParseException extends Exception {
     ...
     * constructor generates a new object of this type with the fields {@link #currentToken}, {@link
     * #expectedTokenSequences}, and {@link #tokenImage} set. The boolean flag {@link #specialConstructor} is
     * also set to true to indicate that this constructor was used to create this object. This constructor
     * calls its super class with the empty string to force the {@link Exception#toString()} method of parent
     * class {@link Throwable} to print the error message in the form: ParseException: &lt;result of
     * getMessage&gt;
     *
