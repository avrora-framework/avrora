...
public class MSP430Disassembler implements AbstractDisassembler {
    ...
    /**
     * The <code>addr0</code> field stores a reference to the root of a decoding
    ...
    private int word1;
    /**
     * The <code>word2</code> field stores a word-sized chunk of the instruction
     * stream. It is used by the decoders instead of repeatedly accessing the
     * array. This implementation has been configured with 16-bit words.
     */
    private int word2;
    ...
    /**
     * The <code>make_addr0()</code> method creates a new instance of a decoding
     ...
     * initialization of the disassembler to build a single shared instance of
     ...
     * addressing mode and instruction resolution trees, the loop compares bits
     * in the bit patterns and moves down the two trees in parallel. When both
     * trees reach an endpoint, the comparison stops and an instruction will be
    ...
    static class SYMIND_0_reader extends OperandReader {
        ...
        MSP430AddrMode read(MSP430Disassembler d) {
            ...
            MSP430Operand.IMM dest_index = new MSP430Operand.IMM(
                    signExtend(readop_2(d), 16));
            MSP430Operand.INDX dest = new MSP430Operand.INDX(dest_reg,
                    dest_index);
    ...
    static class INDSYM_0_reader extends OperandReader {
        ...
        MSP430AddrMode read(MSP430Disassembler d) {
            ...
            MSP430Operand.SREG source_reg = new MSP430Operand.SREG(
                    GPR_table[readop_3(d)]);
            MSP430Operand.IMM source_index = new MSP430Operand.IMM(
                    signExtend(readop_0(d), 16));
            MSP430Operand.INDX source = new MSP430Operand.INDX(source_reg,
                    source_index);
            MSP430Operand.SYMB dest = new MSP430Operand.SYMB(d.pc,
                    signExtend(readop_2(d), 16));
     ...
     * decoding tree reaches a node where the instruction is known. This action
    ...
    /**
     * The <code>DTLoop</code> class is a node that terminates the exploration
