...
/**
 * The <code>MSP430Instr</code> class is a container (almost a namespace) for
 * all of the instructions in this architecture. Each inner class represents an
...
public abstract class MSP430Instr implements AbstractInstr
{
    ...
    /**
     * The default constructor for the <code>MSP430Instr</code> class accepts a
    ...
    public abstract static class SINGLE_W_Instr extends MSP430Instr
    {
        ...
        protected SINGLE_W_Instr(String name, int size,
                MSP430AddrMode.SINGLE_W am)
        {
            super(name, size);
            this.am = am;
    ...
    public abstract static class DOUBLE_W_Instr extends MSP430Instr
    {
        ...
        protected DOUBLE_W_Instr(String name, int size,
                MSP430AddrMode.DOUBLE_W am)
        {
            super(name, size);
            this.am = am;
            this.source = am.get_source();
    ...
    public abstract static class SINGLE_B_Instr extends MSP430Instr
    {
        ...
        protected SINGLE_B_Instr(String name, int size,
                MSP430AddrMode.SINGLE_B am)
        {
            super(name, size);
            this.am = am;
            this.source = am.get_source();
    ...
    public abstract static class DOUBLE_B_Instr extends MSP430Instr
    {
        ...
        protected DOUBLE_B_Instr(String name, int size,
                MSP430AddrMode.DOUBLE_B am)
        {
            super(name, size);
            this.am = am;
            this.source = am.get_source();
