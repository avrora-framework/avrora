...
/**
 * The <code>MSP430Operand</code> interface represents operands that are allowed
 * to instructions in this architecture. Inner classes of this interface
 * enumerate the possible operand types to instructions and their constructors
 * allow for dynamic checking of correctness constraints as expressed in the
...
public abstract class MSP430Operand
{
     ...
     * the operand. This code can be used to dispatch on the type of the operand
     * by switching on the code.
     */
    ...
    /**
     * The <code>MSP430Operand.Int</code> class is the super class of operands
     * that can take on integer values. It implements rendering the operand as
     * an integer literal.
     */
    ...
    /**
     * The <code>MSP430Operand.Sym</code> class is the super class of operands
     * that can take on symbolic (enumerated) values. It implements rendering
     * the operand as the name of the corresponding enumeration type.
     */
    ...
    /**
     * The <code>MSP430Operand.Addr</code> class is the super class of operands
     * that represent an address. It implements rendering the operand as a
     * hexadecimal number.
     */
    ...
    /**
     * The <code>MSP430Operand.Rel</code> class is the super class of operands
     * that represent an address that is computed relative to the program
     * counter. It implements rendering the operand as the PC plus an offset.
     */
    ...
    public static class SYMB extends Rel
    {
        ...
        SYMB(int pc, int rel)
        {
            super(SYMB_val, pc + 1 + rel,
                    MSP430InstrBuilder.checkValue(rel, low, high));
        }
