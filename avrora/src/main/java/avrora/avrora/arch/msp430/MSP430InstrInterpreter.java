...
/**
 * The <code>MSP430InstrInterpreter</code> class contains the code for executing
 * each of the instructions for the "msp430" architecture. It extends the
 * MSP430State class, which is code written by the user that defines the state
 * associated with the interpreter.
 */
public abstract class MSP430InstrInterpreter extends MSP430State
        implements MSP430InstrVisitor
{
    ...
    int $read_poly_int8(MSP430Operand o)
    {
        ...
        case MSP430Operand.IREG_val:
            return $read_int8((MSP430Operand.IREG) o);
        case MSP430Operand.INDX_val:
            return $read_int8((MSP430Operand.INDX) o);
        case MSP430Operand.AIREG_B_val:
            return $read_int8((MSP430Operand.AIREG_B) o);
        case MSP430Operand.IMM_val:
            return $read_int8((MSP430Operand.IMM) o);
        case MSP430Operand.SREG_val:
            return $read_int8((MSP430Operand.SREG) o);
        case MSP430Operand.ABSO_val:
            return $read_int8((MSP430Operand.ABSO) o);
        case MSP430Operand.SYMB_val:
            return $read_int8((MSP430Operand.SYMB) o);
        case MSP430Operand.IMML_val:
            return $read_int8((MSP430Operand.IMML) o);
        }
    ...
    void $write_poly_uint16(MSP430Operand o, int value)
    {
        ...
        {
        case MSP430Operand.IMM_val:
            $write_uint16((MSP430Operand.IMM) o, value);
            return;
        case MSP430Operand.SREG_val:
            $write_uint16((MSP430Operand.SREG) o, value);
            return;
        case MSP430Operand.IMML_val:
            $write_uint16((MSP430Operand.IMML) o, value);
            return;
        case MSP430Operand.AIREG_W_val:
            $write_uint16((MSP430Operand.AIREG_W) o, value);
            return;
        case MSP430Operand.INDX_val:
            $write_uint16((MSP430Operand.INDX) o, value);
            return;
        case MSP430Operand.IREG_val:
            $write_uint16((MSP430Operand.IREG) o, value);
            return;
        case MSP430Operand.ABSO_val:
            $write_uint16((MSP430Operand.ABSO) o, value);
            return;
        case MSP430Operand.SYMB_val:
            $write_uint16((MSP430Operand.SYMB) o, value);
            return;
        }
        throw Util.failure("invalid operand type in write");
    }
    ...
    public int $read_int8(MSP430Operand.INDX _this)
    {
        bumpPC();
        return map_get(data,
                $read_uint16(_this.reg) + $read_uint16(_this.index));
    }
    ...
    {
        map_set(data, $read_uint16(_this.reg) + $read_uint16(_this.index),
                value);
    }
    ...
    public void visit(MSP430Instr.BIC i)
    {
        $write_poly_uint16(i.dest,
                ~$read_poly_uint16(i.source) & $read_poly_uint16(i.dest));
    }
    ...
    public void visit(MSP430Instr.BIC_B i)
    {
        $write_poly_int8(i.dest,
                ~$read_poly_int8(i.source) & $read_poly_int8(i.dest));
    }
