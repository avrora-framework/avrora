...
public abstract class MSP430InstrBuilder
{
    ...
    public static final MSP430InstrBuilder ADD_B = add("add.b",
            new ADD_B_builder());
    public static final MSP430InstrBuilder ADDC = add("addc",
            new ADDC_builder());
    public static final MSP430InstrBuilder ADDC_B = add("addc.b",
            new ADDC_B_builder());
    public static final MSP430InstrBuilder AND = add("and", new AND_builder());
    public static final MSP430InstrBuilder AND_B = add("and.b",
            new AND_B_builder());
    public static final MSP430InstrBuilder BIC = add("bic", new BIC_builder());
    public static final MSP430InstrBuilder BIC_B = add("bic.b",
            new BIC_B_builder());
    public static final MSP430InstrBuilder BIS = add("bis", new BIS_builder());
    public static final MSP430InstrBuilder BIS_B = add("bis.b",
            new BIS_B_builder());
    public static final MSP430InstrBuilder BIT = add("bit", new BIT_builder());
    public static final MSP430InstrBuilder BIT_B = add("bit.b",
            new BIT_B_builder());
    public static final MSP430InstrBuilder CALL = add("call",
            new CALL_builder());
    public static final MSP430InstrBuilder CMP = add("cmp", new CMP_builder());
    public static final MSP430InstrBuilder CMP_B = add("cmp.b",
            new CMP_B_builder());
    public static final MSP430InstrBuilder DADD = add("dadd",
            new DADD_builder());
    public static final MSP430InstrBuilder DADD_B = add("dadd.b",
            new DADD_B_builder());
    ...
    public static final MSP430InstrBuilder MOV_B = add("mov.b",
            new MOV_B_builder());
    public static final MSP430InstrBuilder PUSH = add("push",
            new PUSH_builder());
    public static final MSP430InstrBuilder PUSH_B = add("push.b",
            new PUSH_B_builder());
    public static final MSP430InstrBuilder RETI = add("reti",
            new RETI_builder());
    public static final MSP430InstrBuilder RRA = add("rra", new RRA_builder());
    public static final MSP430InstrBuilder RRA_B = add("rra.b",
            new RRA_B_builder());
    public static final MSP430InstrBuilder RRC = add("rrc", new RRC_builder());
    public static final MSP430InstrBuilder RRC_B = add("rrc.b",
            new RRC_B_builder());
    public static final MSP430InstrBuilder SUB = add("sub", new SUB_builder());
    public static final MSP430InstrBuilder SUB_B = add("sub.b",
            new SUB_B_builder());
    public static final MSP430InstrBuilder SUBC = add("subc",
            new SUBC_builder());
    public static final MSP430InstrBuilder SUBC_B = add("subc.b",
            new SUBC_B_builder());
    public static final MSP430InstrBuilder SWPB = add("swpb",
            new SWPB_builder());
    ...
    public static final MSP430InstrBuilder TST_B = add("tst.b",
            new TST_B_builder());
    public static final MSP430InstrBuilder XOR = add("xor", new XOR_builder());
    public static final MSP430InstrBuilder XOR_B = add("xor.b",
            new XOR_B_builder());
