...
/**
 * The <code>MSP430Symbol</code> class represents a symbol (or an enumeration as
 * declared in the instruction set description) relevant to the instruction set
 * architecture. For example register names, status bit names, etc are given
 * here. This class provides a type-safe enumeration for such symbolic names.
 */
