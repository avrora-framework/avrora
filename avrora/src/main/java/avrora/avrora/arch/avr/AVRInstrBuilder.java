...
public abstract class AVRInstrBuilder
{
    ...
    public static final AVRInstrBuilder BREAK = add("break",
            new BREAK_builder());
    ...
    public static final AVRInstrBuilder EICALL = add("eicall",
            new EICALL_builder());
    public static final AVRInstrBuilder EIJMP = add("eijmp",
            new EIJMP_builder());
    ...
    public static final AVRInstrBuilder FMULS = add("fmuls",
            new FMULS_builder());
    public static final AVRInstrBuilder FMULSU = add("fmulsu",
            new FMULSU_builder());
    public static final AVRInstrBuilder ICALL = add("icall",
            new ICALL_builder());
    ...
    public static final AVRInstrBuilder MULSU = add("mulsu",
            new MULSU_builder());
    ...
    public static final AVRInstrBuilder RCALL = add("rcall",
            new RCALL_builder());
    ...
    public static final AVRInstrBuilder SLEEP = add("sleep",
            new SLEEP_builder());
