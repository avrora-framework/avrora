...
/**
 * The <code>AVRAddrMode</code> class represents an addressing mode for this
 * architecture. An addressing mode fixes the number and type of operands, the
 * syntax, and the encoding format of the instruction.
 */
public interface AVRAddrMode
{
    ...
    public static class $ldd$ implements AVRAddrMode
    {
        ...
        public $ldd$(AVROperand.op_GPR rd, AVROperand.op_YZ ar,
                AVROperand.IMM6 imm)
        {
            this.rd = rd;
            this.ar = ar;
    ...
    public static class $std$ implements AVRAddrMode
    {
        ...
        public $std$(AVROperand.op_YZ ar, AVROperand.IMM6 imm,
